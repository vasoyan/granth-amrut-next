...
export default function SignInPage() {
  ...
  const onLogin = async () => {
    try {
      ...
      if (response.success && response.data) {
        authContext?.signIn(response.data as users);
  ...
  useEffect(() => {
    setButtonDisabled(!user.username || !user.userpass);
  }, [user]);
